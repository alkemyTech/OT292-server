...
router.post('/', validateToken, verifyAdmin, uploadMiddleware.single('image'), validator.validateCreation, controller.create);
...
router.put('/:id', validateToken, verifyAdmin, uploadMiddleware.single('image'), validator.validateUpdate, controller.update);
